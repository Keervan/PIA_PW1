    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                %>
                <a href="LikeNoticia?idNew=<%= noticia.getId()%>">
                ...
                <a href="DislikeNoticia?idNew=<%= noticia.getId()%>">
                ...
                <div class="col-12 commentaries p-5">
                    ...
                    <div class="media">
                        ...
                        <img src="assets/image/anonimo.jpg" class="mr-3" alt="...">
                        <div class="media-body">
                            <h5 class="mt-0">Anónimo</h5>
                            <small class="col-12 text-muted">Creado: <%= comentary.getFecha()%> </small>
                            <a href="LikeComentario?idCom=<%= comentary.getId()%>&idNew=<%= noticia.getId()%>">
